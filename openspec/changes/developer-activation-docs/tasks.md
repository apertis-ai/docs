## 1. Canonical activation content

- [x] 1.1 Rewrite Quick Start to cover account creation, plan or PAYG access, canonical key creation, a successful request, and Activity verification.
- [x] 1.2 Replace legacy key destinations and remove internal acquisition UTMs across active documentation.
- [x] 1.3 Add a visible Create account destination to the docs navigation while retaining Log in.
- [x] 1.4 Remove remaining fixed model-count claims from high-intent docs and link the live catalog.

## 2. Drift prevention and verification
