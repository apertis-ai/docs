...
| `APERTIS_AUTH_TOKEN` | Your personal API key from [Apertis Dashboard](https://apertis.ai/token). | `sk-xxxx...` |
| `DEFAULT_MODEL` | The model used when running `ccs --apertis` without specifying a model. Use the `code:` prefix for coding tools. | `code:claude-opus-4-6` |
...
| `code:claude-opus-4-6-thinking` | Claude Opus 4.6 with extended thinking |
| `code:claude-opus-4-6` | Claude Opus 4.6 — most capable |
| `code:claude-opus-4-5-20251101-thinking` | Claude Opus 4.5 with extended thinking |
| `code:claude-opus-4-5-20251101` | Claude Opus 4.5 |
...
| `code:claude-opus-4-1-20250805-thinking` | Claude Opus 4.1 with extended thinking |
| `code:claude-opus-4-1-20250805` | Claude Opus 4.1 |
