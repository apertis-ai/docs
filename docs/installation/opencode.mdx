...
# <svg viewBox="0 0 24 24" fill="currentColor" fillRule="evenodd" width="36" height="36" style={{display: 'inline-block', verticalAlign: 'middle', marginRight: 8}}><path d="M16 6H8v12h8V6zm4 16H4V2h16v20z"/></svg> OpenCode
